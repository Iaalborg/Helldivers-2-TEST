...
#### This is a PoC that I created to learn about dll proxy using C++ on 64bit application / game. well lets hope this stuff works because if it does, i can compete with the others
